...
const PlanetScoreMainScore = ({ score }: { score: ScoreValues }) => {
  switch (score) {
    case 'A':
      return (
        <g id="score-A">
          <ellipse
            transform="matrix(0.7071 -0.7071 0.7071 0.7071 -255.564 300.5128)"
            style={{ fill: '#027D3D' }}
            cx="235"
            cy="458.7"
            rx="117"
          ...
          <path
            style={{ fill: '#FFFFFF' }}
            d="M324.3,369.4c-23.9-23.9-55.6-37-89.4-37c-33.8,0-65.5,13.1-89.4,37c-23.9,23.9-37,55.6-37,89.4
          ...
          <path
            style={{ fill: '#FFFFFF' }}
            d="M169,512.5l43.4-117.3c2-5.4,5.1-9.7,9.1-13c4-3.3,8.7-4.9,13.9-4.9c5.5,0,10.3,1.6,14.3,4.8
    ...
    case 'B':
      return (
        <g id="score-B">
          ...
          <path
            style={{ fill: '#FFFFFF' }}
            d="M183.1,517.1V397c0-5,1.6-8.9,4.8-11.8c3.2-2.8,7.2-4.2,12.2-4.2h41.1c7.4,0,14.2,1.6,20.3,4.7
    ...
    case 'C':
      return (
        <g id="score-C">
          ...
          <path
            style={{ fill: '#FFFFFF' }}
            d="M167,456.7c0-11.2,1.8-21.6,5.4-31.3c3.6-9.7,8.7-18.1,15.3-25.4c6.6-7.2,14.5-12.8,23.5-16.8
    ...
    case 'D':
      return (
        <g id="score-D">
          ...
          <path
            style={{ fill: '#FFFFFF' }}
            d="M175.8,517.2V396.6c0-4.9,1.6-8.9,4.7-12c3.2-3.1,7.1-4.6,11.9-4.6h35.8c12.1,0,22.8,1.9,32.3,5.6
    ...
    case 'E':
      return (
        <g id="score-E">
          ...
          <path
            style={{ fill: '#FFFFFF' }}
            d="M194.3,517.2V398.7c0-5.6,1.4-10.1,4.3-13.6c2.9-3.4,7.1-5.2,12.5-5.2h53.5c4.9,0,8.7,1.5,11.3,4.4
